  ...
  return (
    <LampContainer>
      <motion.h1
        ...
        className="mt-8 bg-gradient-to-br from-primary to-secondary py-4 bg-clip-text text-center text-4xl font-medium tracking-tight text-transparent md:text-7xl"
      >
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        <div className="relative w-full h-full flex items-center justify-center scale-y-125 isolate z-0">
          <motion.div
      ...
      {/* Content container - centered in the middle of the lamp effect */}
      <div className="relative z-50 flex flex-col items-center justify-center px-5 w-full h-full mt-[350px]">
        {children}
      </div>
    </div>
  );
